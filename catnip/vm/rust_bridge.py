...
from ..exc import CatnipNameError, CatnipRuntimeError, CatnipTypeError
...
def _convert_rust_exception(exc: Exception) -> Exception:
    ...
    # TypeError - return CatnipTypeError for enrichment with source location
    if msg.startswith("TypeError: "):
        type_msg = msg[len("TypeError: ") :]
