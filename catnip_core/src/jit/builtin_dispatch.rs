// FILE: catnip_core/src/jit/builtin_dispatch.rs
...
use crate::nanbox::{PAYLOAD_MASK, SMALLINT_SIGN_BIT, SMALLINT_SIGN_EXT};
...
#[no_mangle]
pub extern "C" fn catnip_call_builtin(builtin_id: i64, arg0: i64, _arg1: i64, _num_args: i64) -> i64 {
...
mod tests {
    ...
    use crate::nanbox::{QNAN_BASE, TAG_SMALLINT};
