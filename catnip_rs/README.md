...
**Important**: The `embedded` feature is incompatible with `extension-module` (default). Always use
`--no-default-features --features embedded` when building standalone binaries.
