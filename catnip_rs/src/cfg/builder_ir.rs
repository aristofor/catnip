...
mod tests {
    ...
    fn test_iropcodes_values() {
        ...
        assert_eq!(IROpCode::OpIf as i32, 2);
        assert_eq!(IROpCode::OpWhile as i32, 3);
        assert_eq!(IROpCode::OpFor as i32, 4);
        assert_eq!(IROpCode::OpMatch as i32, 5);
        assert_eq!(IROpCode::OpBlock as i32, 6);
        assert_eq!(IROpCode::OpReturn as i32, 7);
        assert_eq!(IROpCode::OpBreak as i32, 8);
        assert_eq!(IROpCode::OpContinue as i32, 9);
    }
}
