...
mod tests {
    ...
    fn test_inline_simple_pure() {
        ...
        registry.register("add_one".to_string(), std::sync::Arc::new(code));
    ...
    fn test_inline_size_limit() {
        ...
        registry.register("big_fn".to_string(), std::sync::Arc::new(code));
    ...
    fn test_inline_depth_limit() {
        ...
        registry.register("f".to_string(), std::sync::Arc::new(f));
    ...
    fn test_inline_closure_with_scope() {
        ...
        registry.register("use_outer".to_string(), std::sync::Arc::new(code));
