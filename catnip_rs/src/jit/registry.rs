...
pub struct PureFunctionRegistry {
    ...
    functions: HashMap<String, CodeObject>,
}
...
impl PureFunctionRegistry {
    ...
    pub fn register(&mut self, func_id: String, code: CodeObject) {
        if code.is_pure {
...
mod tests {
    ...
    fn test_register_pure() {
        ...
        registry.register("test_fn".to_string(), code);
    ...
    fn test_register_impure() {
        ...
        registry.register("impure_fn".to_string(), code);
