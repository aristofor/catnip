...
Catnip charge des modules Python via `import("module")` ou l'option CLI `-m module`. Les objets et fonctions
...
| [web/](web/)                       | HTTP et APIs                   | httpx                                              |
| [images-media/](images-media/)     | Images et multimédia           | pillow                                             |
| [geospatial/](geospatial/)         | Géospatial                     | math (haversine)                                   |
| [geometry/](geometry/)             | Géométrie                      | enveloppe convexe (Graham scan)                    |
