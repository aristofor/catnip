...
Ces 2 chemins justifient la duplication des **tests de comportement langage** (parité VM/AST), mais pas la duplication
systématique des **tests internes de passes**.
