...
- [03_cfg_optimization.md](03_cfg_optimization.md) - Optimisations (dead code, fusion, branches constantes)
- [04_cfg_reconstruction.md](04_cfg_reconstruction.md) - Reconstruction de code structuré depuis CFG
