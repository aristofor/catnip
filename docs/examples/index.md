...
- [`cache_demo.py`](performance/cache_demo.py) - Démonstration du système de cache
- [`cache_memory_example.py`](performance/cache_memory_example.py) - Cache en mémoire
- [`cache_disk_example.py`](performance/cache_disk_example.py) - Cache sur disque
- [`cache_redis_example.py`](performance/cache_redis_example.py) - Cache Redis
- [`cache_comparison.py`](performance/cache_comparison.py) - Comparaison des backends
- [`memoization_build_script.py`](performance/memoization_build_script.py) - Script de build avec cache
- [`memoization_dependencies.py`](performance/memoization_dependencies.py) - Gestion des dépendances
- [`memoization_python_hooks.py`](performance/memoization_python_hooks.py) - Hooks Python pour cache
- [`tail_recursion_benchmark.py`](performance/tail_recursion_benchmark.py) - Benchmark transformation tail recursion →
  loop
- [`jit_benchmark.py`](performance/jit_benchmark.py) - Benchmark compilation JIT
- [`pure_function_inlining.md`](performance/pure_function_inlining.md) - Inline de fonctions pures dans le JIT
  (10-30% speedup)
- [`vm_mode_benchmark.py`](performance/vm_mode_benchmark.py) - Comparaison VM vs AST
