...
# Error: No pattern matched for value: 9
```
...
[*Sketches of an Elephant*](https://math.jhu.edu/~eriehl/ct/sketches-of-an-elephant.pdf), vol. 1, D1.3). Le pattern matching construit une fonction partielle (valeur → bindings) avec
des garanties de décision unique et prévisible. Cette structure explique pourquoi :
