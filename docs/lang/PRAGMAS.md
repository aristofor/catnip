...
- Le mode debug
- Les indications de fonction (fonctions pures)
...
> La compilation JIT ne réussit que pour les fonctions correspondant à un motif compilable
> (actuellement : fonctions récursives terminales simples avec 1 à 3 paramètres entiers).
> Les fonctions non conformes s'exécutent normalement via l'interpréteur.
...
Voir [OPTIMIZATIONS](../dev/OPTIMIZATIONS.md#3-jit-compilation-cranelift) pour les détails techniques.
